  ...
  return (
    <div className="error-page-container">
      <div className="error-visual-pane dark">
        ...
        <img src="/logo-icon.png" alt="" className="sf-brand-footer" />
      ...
      <div className="error-message-pane">
        ...
        <p className="error-description">
          This area of the workshop is restricted. Your current security clearances
        ...
        <div className="error-meta">
          <div className="error-meta-item">
            Security Protocol
            <strong>ACTIVE ENFORCEMENT</strong>
          </div>
